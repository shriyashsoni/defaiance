...
export interface StartupPoolFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "allPools"
...
export interface StartupPoolFactory extends BaseContract {
  connect(runner?: ContractRunner | null): StartupPoolFactory;
  waitForDeployment(): Promise<this>;

  interface: StartupPoolFactoryInterface;
  ...
  createPool: TypedContractMethod<
    [asset: AddressLike, manager: AddressLike, name: string, symbol: string],
    [string],
    "nonpayable"
  >;
  ...
  filters: {
    "PoolCreated(address,address,address,string,string)": TypedContractEvent<
      PoolCreatedEvent.InputTuple,
      PoolCreatedEvent.OutputTuple,
      PoolCreatedEvent.OutputObject
    >;
