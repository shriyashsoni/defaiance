...
export interface DefaianceTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DefaianceToken extends BaseContract {
  connect(runner?: ContractRunner | null): DefaianceToken;
  waitForDeployment(): Promise<this>;

  interface: DefaianceTokenInterface;
